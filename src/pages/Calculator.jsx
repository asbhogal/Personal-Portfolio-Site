  ...
  return (
    <>
      ...
      >
        ...
        >
          This project was a Frontend Mentor challenge which required creating a
          fully functional Calculator app with three themes and the ability to
          toggle between them from a brief and style guide. The following
          changes were subsequently made to improve the aesthetics,
          accessibility and UX of the app:
          <ul>
            <li>
              A redesigned UI complete with a light, dark and blue monochromatic
              theme and modern typeface
            </li>
            <li>
              ...
              component variants used to couple the styling with the JSX markup
      ...
      >
        ...
        <m.p
          ...
          className="ProjectAboutContent"
        >
          The decision was made to change the original design brief to reflect
          something more contemporary. The Inter typeface was chosen (weights
          400, 500, 700) for a clear, clean, modern and affirmed typography with
          accentuated x-heights for improved readability with mixed-case and
          lower-case text. The three themes therefore chosen instead also
          aligned with modern-day styling: a conventional light (white) version,
          dark (black) version and blue version, each following a
          monochromatic-set of shades for visual consistency. Blue was chosen as
          the third and final theme for its medium between the two, harmonious
          and muted.
        </m.p>
      </m.section>
