      ...
      >
        ...
        >
          ...
          <m.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}>
            Developing strong, consistent and recognisable branding which evokes
            emotions through visualisations and mood boards.
          </m.p>
        </m.div>
        <m.div
          initial={{ opacity: 0 }}
        ...
        >
          ...
          <m.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}>
            Developing modern, front-end applications and websites from scratch
            or existing mockups using React, Next.js, SASS and Webpack
          </m.p>
        </m.div>
        <m.div
          initial={{ opacity: 0 }}
