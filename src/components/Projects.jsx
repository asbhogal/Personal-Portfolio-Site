                ...
                <div className="ProjectSection">
                    <div className="ProjectInfo">
                        ...
                        <div className="DesignBrief">
                            <h3>Design Brief</h3>
                            <p className="DesignBriefSummary">Luxury and allure were key in communicating the message behind this brand. The font used symbolises the nature of the sea and open waters; vast and spacious yet defined and affirmed; reinforced by the semi bold and bold weightings. The logo of a wave is simplistic and therefore easily memorable; it's character parallels that of the typography leveraged and against the rich black backdrop rings true the message of style and class.</p>
                        </div>
