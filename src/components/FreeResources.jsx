      ...
      >
        ...
        >
          ...
          <m.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}>
            ...
            demonstrate Figma's auto layout capabilities across five common
            screen breakpoints (1440px+, 1440px, 1024px, 744px, 375px). Please
            note that these are for demonstrative purposes and user-centred
            research should always be carried out prior.
          </m.p>
          <m.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
