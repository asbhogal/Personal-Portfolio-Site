...
import brandHeroImg from "../assets/images/BRAND/mockups/BrandHeroImg.jpg";
import brandMockups from "../assets/images/BRAND/mockups/BrandMockups.png";
import brandiPhoneToggleImage from "../assets/images/BRAND/mockups/Brand-iPhoneToggleMockup.jpg";
import brandiMacImage from "../assets/images/BRAND/mockups/Brand-iMacMockup.jpg";
import brandMacBookImage from "../assets/images/BRAND/mockups/Brand-MacBookMockup.jpg";
import brandiPadImage from "../assets/images/BRAND/mockups/Brand-iPadMockup.jpg";
import brandiPad2Image from "../assets/images/BRAND/mockups/Brand-iPad2Mockup.jpg";
import CTA from "./CTA";
    ...
    <>
      ...
      <div className="Project">
        ...
        >
          ...
          >
            Brand is a conceptualised company which offers minimalistic interior
            decorating options inspired by Milanese design. Logos and assets
            were provided and from these, five responsive templates (for 5
            breakpoints) were created using Figma. A responsive Web page from
            these was then built using React with SCSS, Babel and JS, compiled
            as a production build using Webpack and then shipped using Vercel.
          </m.p>
        </m.section>
        ...
        >
          ...
          <m.p
            ...
            className="ProjectAboutContent"
          >
            The templates were kept consistent in design, aesthetic and layout.
            The clean, minimalistic structure with attention to whitespacing,
            legibility and heirarchy was also respected, paralleling the
            affluence communicated by the brand. The logo itself is assured,
            sharp and rigid, to emphasise the nature and quality of their
            products. The anti-flash white provides a medium through which the
            two extremes of black and white fuse in different elements at play
            and merge across various content typesets, yet still manage to
            become two distinct entities in their own right, emboldened by the
            contrasting logos used.
          </m.p>
        </m.section>
