  ...
  const resources: ResourcesType[] = [
    {
      ...
      img: "/images/resources/ResponsiveWireframes.jpg",
      imgAlt:
        "A close up screenshot of some responsive website wireframe templates at an angle",
    ...
    },
    {
      ...
      description:
        "A set of responsive wireframes for a typical company home page to demonstrate Figma's auto layout capabilities across five common screen breakpoints (1440px+, 1440px, 1024px, 744px, 375px). Please note that these are for demonstrative purposes and user-centred research should always be carried out prior.",
      img: "/images/resources/BrandBoardTemplate.jpg",
      imgAlt:
        "A close up of a brand board template in two parts, layered over one another, with information on the left of it",
    ...
    },
    {
      ...
      img: "/images/resources/JuniorDeveloperTemplate.jpg",
      imgAlt:
        "A close up screenshot of a junior developer portfolio template at an angle, with information on the left of it",
